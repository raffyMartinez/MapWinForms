...
namespace MapWinForms.forms
{
    ...
    public partial class LayerPropertyForm : Form
    {
        ...
        private LayersForm _parentForm;
        ...
        public LayersForm ParentLayerform
        {
        ...
        private void OnButtonClick(object sender, EventArgs e)
        {
            switch (((Button)sender).Name)
            {
                case "btnClear":
                    ...
                    _parentForm.MainForm.MapControl.Redraw();
                    break;

                case "btnLabelFeatures":
                    var labelsForm = LabelsForm.GetInstance(_mapLayers,this );
