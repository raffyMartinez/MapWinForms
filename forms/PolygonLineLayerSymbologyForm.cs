...
namespace MapWinForms.forms
{
    public partial class PolygonLineLayerSymbologyForm : Form
    {
        ...
        private void OnFormLoad(object sender, EventArgs e)
        {
            ...
            icbHatchType.ComboStyle = ImageComboStyle.HatchStyle;
            icbLineStyle.ComboStyle = ImageComboStyle.LineStyle;
        ...
        {
            _parentForm.ParentLayerform.ShapefileLayerPropertyChanged();
        }
