...
namespace MapWinForms.forms
{
    public partial class LabelsForm : Form
    {
        ...
        public static LabelsForm GetInstance(MapLayersHandler layersHandler, LayerPropertyForm parentForm)
        {
            if (_instance == null) _instance = new LabelsForm(layersHandler,parentForm);
            return _instance;
        }



        public LabelsForm(MapLayersHandler layersHandler, LayerPropertyForm parentForm)
        {
            InitializeComponent();
        ...
        private void ApplyLabelProperties()
        {
            ...
            _parentForm.ParentLayerform.MainForm.MapControl.Redraw();
        }
